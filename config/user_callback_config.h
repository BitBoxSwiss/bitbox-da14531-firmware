...
static const struct app_callbacks user_app_callbacks = {
    .app_on_connection = user_app_on_connection_cb,
    .app_on_disconnect = user_app_on_disconnect_cb,
    .app_on_update_params_rejected = NULL,
    .app_on_update_params_complete = NULL,
    .app_on_set_dev_config_complete = default_app_on_set_dev_config_complete,
    .app_on_adv_nonconn_complete = NULL,
    .app_on_adv_undirect_complete = user_app_adv_undirect_complete_cb,
    ...
    .app_on_tk_exch = user_app_on_tk_exch_cb,
    .app_on_irk_exch = NULL,
    .app_on_csrk_exch = default_app_on_csrk_exch,
    .app_on_ltk_exch = default_app_on_ltk_exch,
    .app_on_pairing_succeeded = user_app_on_pairing_succeeded_cb,
    .app_on_encrypt_ind = user_app_on_encrypt_ind_cb,
...
static const struct app_bond_db_callbacks user_app_bond_db_callbacks = {
    ...
    .app_bdb_get_number_of_stored_irks =
        default_app_bdb_get_number_of_stored_irks,
    .app_bdb_get_stored_irks = default_app_bdb_get_stored_irks,
    .app_bdb_get_device_info_from_slot =
        default_app_bdb_get_device_info_from_slot,
};
#endif // (BLE_APP_SEC)

#define app_process_catch_rest_cb user_app_process_catch_rest_cb

static const struct arch_main_loop_callbacks user_app_main_loop_callbacks = {
    .app_on_init = user_app_on_init_cb,

    // By default the watchdog timer is reloaded and resumed when the system
    // wakes up.
    // The user has to take into account the watchdog timer handling (keep it
    // running,
    // freeze it, reload it, resume it, etc), when the app_on_ble_powered() is
    // being
    ...
    // The user has to take into account the watchdog timer handling (keep it
    // running,
    // freeze it, reload it, resume it, etc), when the app_on_system_powered()
    // is being
    // called and may potentially affect the main loop.
...
static const struct default_app_operations user_default_app_operations = {
    .default_operation_adv = user_default_operation_adv_cb,
};
